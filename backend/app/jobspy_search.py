...
# Mapping région MiniLLM -> nom de pays attendu par JobSpy
JOBSPY_LOCATION_MAP = {
    "tunisie": "Tunisia",
    "france": "France",
    "maroc": "Morocco",
...
# Mapping niveau d'expérience MiniLLM -> valeur attendue par JobSpy (LinkedIn uniquement)
...
# Mapping durée MiniLLM -> heures (hours_old attendu par JobSpy)
TIMELIMIT_TO_HOURS = {
    "jour": 24,
    "semaine": 168,
    "mois": 720,
...
def search_via_jobspy(
    ...
    """
    Recherche via JobSpy (site = "linkedin" ou "indeed") et retourne une liste
    de dicts déjà au format attendu par JobOffer (pas besoin de passer par le LLM).
    """
